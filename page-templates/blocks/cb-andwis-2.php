	...
	<div class="container">
		<div class="row g-4">
			<div class="col-12 col-xxl-4">
				...
				<a class="btn btn-primary" href="https://www.andwis.com/about-andwis/our-companies/" target="_blank">Find out More</a>
			</div>
			<div class="col-12 col-xxl-8">
				<div class="row g-2">
					<div class="col-md-6 col-lg-4">
						<div class="service-card position-relative overflow-hidden ps-2 pe-4 pb-4 pt-3 h-100">
							<div class="service-card__front position-relative z-1">
								<div class="service-card__icons">
									<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/andwis/service-icons/service-fire-and-security.svg' ); ?>" alt="Fire and Security Icon" class="img-fluid">
								</div>
					...
					<div class="col-md-6 col-lg-4">
						<div class="service-card position-relative overflow-hidden ps-2 pe-4 pb-4 pt-3 h-100">
							<div class="service-card__front position-relative z-1">
								<div class="service-card__icons">
									<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/andwis/service-icons/service-water-air-hygiene.svg' ); ?>" alt="Water and Air Hygiene Icon" class="img-fluid">
								</div>
								<div class="service-card__intro">
					...
					<div class="col-md-6 col-lg-4">
						<div class="service-card position-relative overflow-hidden ps-2 pe-4 pb-4 pt-3 h-100">
							<div class="service-card__front position-relative z-1">
								<div class="service-card__icons">
									<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/andwis/service-icons/service-asbestos-management-remediation.svg' ); ?>" alt="Asbestos Management Icon" class="img-fluid">
								</div>
								<div class="service-card__intro">
					...
					<div class="col-md-6 col-lg-4">
						<div class="service-card position-relative overflow-hidden ps-2 pe-4 pb-4 pt-3 h-100">
							<div class="service-card__front position-relative z-1">
								<div class="service-card__icons">
									<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/andwis/service-icons/service-lifts-entrance.svg' ); ?>" alt="Lifts and Entrance Icon" class="img-fluid">
								</div>
								<div class="service-card__intro">
					...
					<div class="col-md-6 col-lg-4">
						<div class="service-card position-relative overflow-hidden ps-2 pe-4 pb-4 pt-3 h-100">
							<div class="service-card__front position-relative z-1">
								<div class="service-card__icons">
									<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/andwis/service-icons/service-maintenance-response.svg' ); ?>" alt="Maintenance and Response Icon" class="img-fluid">
								</div>
								<div class="service-card__intro">
					...
					<div class="col-md-6 col-lg-4">
						<div class="service-card position-relative overflow-hidden ps-2 pe-4 pb-4 pt-3 h-100">
							<div class="service-card__front position-relative z-1">
								<div class="service-card__icons">
									<img src="<?= esc_url( get_stylesheet_directory_uri() . '/img/andwis/service-icons/service-m-e.svg' ); ?>" alt="Mechanical and Electrical Icon" class="img-fluid">
								</div>
								<div class="service-card__intro">
